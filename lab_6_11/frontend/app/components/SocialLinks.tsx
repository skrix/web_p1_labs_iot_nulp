...
const SOCIAL_LINKS = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/vasyl_co/",
    ariaLabel: "Instagram",
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/vasyl.turianyn",
    ariaLabel: "Facebook",
    bgColor: "bg-blue-600",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/vasyl-turianyn-b75839251/",
    ariaLabel: "LinkedIn",
    bgColor: "bg-blue-700",
